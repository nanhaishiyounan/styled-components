...
var windowWidth = reactNative.Dimensions.get('window').width
...
var AtRule = (function(_Container) {
  ...
  function AtRule(defaults$$1) {
    ...
    var _this = possibleConstructorReturn(
      this,
      _Container.call(this, defaults$$1)
    )
...
var SafeParser = (function(_Parser) {
  ...
  SafeParser.prototype.precheckMissedSemicolon = function precheckMissedSemicolon(
    tokens
  ) {
    var colon = this.colon(tokens)
    if (colon === false) return
...
var windowWidth$1 = reactNative.Dimensions.get('window').width
...
var _InlineStyle = function(styleSheet) {
  var InlineStyle = (function() {
    ...
    InlineStyle.prototype.generateStyleObject = function generateStyleObject(
      executionContext
    ) {
      ...
      if (!generated[hash]) {
        ...
        declPairs.map(function(item) {
          // eslint-disable-next-line no-param-reassign
          item[1] = item[1].replace(/(\d+)rem|(\d+)vw|(\d+)vh/g, function(
            strMatch,
            $1,
            $2,
            $3
        ...
        var styleObject = transformDeclPairs(declPairs, [
          'borderRadius',
          'borderWidth',
          'borderColor',
          'borderStyle',
...
var BaseStyledNativeComponent = (function(_Component) {
    ...
    return (
      ...
      (_this.onRef = function(node) {
        ...
        if (typeof innerRef === 'function') {
          ...
          (typeof innerRef === 'undefined'
            ? 'undefined'
            : _typeof(innerRef)) === 'object' &&
          innerRef &&
  ...
  BaseStyledNativeComponent.prototype.buildExecutionContext = function buildExecutionContext(
    theme,
    props
  ) {
  ...
  BaseStyledNativeComponent.prototype.generateAndInjectStyles = function generateAndInjectStyles(
    theme,
    props
  ) {
  ...
  BaseStyledNativeComponent.prototype.componentWillMount = function componentWillMount() {
    ...
    if (styledContext !== undefined) {
      ...
      this.unsubscribeId = subscribe(function(nextTheme) {
        ...
        var generatedStyles = _this2.generateAndInjectStyles(
          theme,
          _this2.props
        )
  ...
  BaseStyledNativeComponent.prototype.componentWillReceiveProps = function componentWillReceiveProps(
    nextProps
  ) {
    var _this3 = this
  ...
  BaseStyledNativeComponent.prototype.setNativeProps = function setNativeProps(
    nativeProps
  ) {
    if (this.root !== undefined) {
      ...
      console.warn(
        'setNativeProps was called on a Styled Component wrapping a stateless functional component. ' +
          ...
          ('Check whether the stateless functional component is passing on innerRef as a ref in ' +
            (displayName || 'UnknownStyledNativeComponent') +
            '.')
      )
    }
  }
...
var _StyledNativeComponent = function(constructWithOptions, InlineStyle) {
  var createStyledNativeComponent = function createStyledNativeComponent(
    target,
    options,
    rules
  ) {
...
var InlineStyle = _InlineStyle(reactNative__default.StyleSheet)
var StyledNativeComponent = _StyledNativeComponent(
