...
describe('flatten', () => {
  ...
  it('defers functions', () => {
    ...
    expect(flatten(['foo', funcWFunc, 'baz'])).toEqual([
      'foo',
      funcWFunc,
      'baz',
    ])
  ...
  it('executes functions', () => {
    const func = () => 'bar'
    expect(flatten(['foo', func, 'baz'], { bool: true })).toEqual([
      'foo',
      'bar',
      'baz',
    ])
  ...
  it('recursively calls functions', () => {
    ...
    expect(flatten(['foo', func], { bool: true })).toEqual([
      'foo',
      'static',
      'bar',
    ])
    expect(flatten(['foo', func], { bool: false })).toEqual([
      'foo',
      'static',
      'baz',
    ])
