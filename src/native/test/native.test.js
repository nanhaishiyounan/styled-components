...
describe('native', () => {
  ...
  it('should combine inline styles and the style prop', () => {
    ...
    const view = wrapper.find('View').first()
    expect(view.prop('style')).toEqual([{ paddingTop: 750 }, style])
  })

  it('should convert media', () => {
    const Comp = styled.View`
      padding-top: ${{ 300: 5, 751: '375rem' }};
      margin-left: 50vw;
      margin-right: ${{ 300: 5, 751: '50vh' }};
    `
    ...
    expect(view.prop('style')).toEqual([
      { paddingTop: 750, marginLeft: 375, marginRight: 667 },
      style,
    ])
  })
